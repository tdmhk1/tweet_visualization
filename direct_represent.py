...
def mapview():
    try:
        ...
        return render_template('direct_represent_web.html', tweet_data=tweet_data, tweet_data_max=tweet_data_max, datatime=datatime, count_data=count_data, linkdata=linkdata)
